    ...
    <div class="py-16 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-12">
                <h1 class="text-4xl font-bold text-gray-900 mb-4">Modifier un produit</h1>

            </div>
            <div class="bg-blue-400">
                <a href="{{ route('Products.show') }}">Retour</a>
            </div>
            <!-- Card du formulaire -->
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div class="p-8">
                    <form method="POST" action="{{ Route('Products.update', $produits->id) }}" class="space-y-8">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="group">
                            ...
                            <input type="text" id="name" name="name" value="{{ $produits->name }}"
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4"
                                class="form-textarea block w-full rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-200 transition-all duration-200 py-3 px-4 text-gray-700">{{ $produits->description }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-500 flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
